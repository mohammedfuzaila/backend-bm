...
# Email Settings - Switched to Brevo (Sendinblue) API for high reliability
BREVO_API_KEY = os.environ.get('BREVO_API_KEY', 'xkeysib-placeholder') 
DEFAULT_FROM_EMAIL = 'anaikarmohammedfuzail57@gmail.com' 
EMAIL_TIMEOUT = 15
